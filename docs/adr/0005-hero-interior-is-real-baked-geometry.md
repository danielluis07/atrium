...
- **Download.** `interior.ktx2` is 0.71 MB (1024², UASTC HDR; 1.40 MB of GPU memory as BC6H), and Senja's GLB grew by 0.01 MB over the wire. The Scene (Target and Lean) went from 17.38 to 17.96 MB over the wire, of 24 MB, and the Houses from 11.74 to 12.32 MB, of 16 MB.
